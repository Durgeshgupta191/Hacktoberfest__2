...
const OTPVerificationPage = () => {
    ...
    const { verifyOTP, resendOTP, isVerifyingOTP, pendingEmail, otpResendTimer } =
        useAuthStore();
            ...
            <div className="hidden lg:flex flex-col justify-center items-center p-12 relative z-10">
                <div className="text-center space-y-6 max-w-md">
                    ...
                    <p className="text-gray-400">
                        We&apos;ve sent a verification code to your email address. Enter it above to verify your account.
                    </p>
                </div>
            </div>
        </div>
